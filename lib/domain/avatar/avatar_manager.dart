...
enum AvatarVisualState {
  charged(
    'Батыр заряжен (Сулайман-Тоо)',
    'ЗАРЯЖЕН',
    AppColors.sage,
    'Высокий Recovery (≥75%), золотой рассвет над Сулайман-Тоо в Оше. Кольцо Sage (+50% к опыту).',
    1.5,
    'assets/images/hero_barys_charged.jpg',
  ),
  normal(
    'Батыр в тонусе (Ала-Тоо)',
    'В ТОНУСЕ',
    AppColors.amber,
    'Оптимальная готовность (50–74%), панорама гор Ала-Тоо. Сбалансированная нагрузка.',
    1.0,
    'assets/images/hero_barys_normal.jpg',
  ),
  tired(
    'Батыр уставший (Ала-Тоо)',
    'ОТДЫХ',
    AppColors.rose,
    'Низкий Recovery (<34%) или вчерашний Strain >16. Вечерний туман Ала-Тоо, режим восстановления.',
    0.8,
    'assets/images/hero_barys_tired.jpg',
  ),
  sleep(
    'Батыр отдыхает (Башня Бурана)',
    'ОТБОЙ',
    AppColors.sage,
    'Позднее время (после 22:00). Звездная ночь над башней Бурана, отдых перед новым днем.',
    1.2,
    'assets/images/hero_barys_sleep.jpg',
  ),
  postWorkout(
    'Батыр после тренировки (Бишкек Арена)',
    'ПОСЛЕ СПОРТА',
    AppColors.amber,
    'Спортивная сессия закрыта, огни прожекторов Бишкек Арены. Восстановите водный баланс.',
    1.3,
    'assets/images/hero_barys_workout.jpg',
  ),
  meditation(
    'Батыр в дзене (Сон-Куль)',
    'БАЛАНС',
    AppColors.sage,
    'Дневной стресс >65. Дыхательные практики и покой на фоне высокогорного озера Сон-Куль.',
    1.1,
    ...
    if (l == AppLanguage.kyrgyz) {
      switch (this) {
        case AvatarVisualState.charged:
          return 'Батыр сергек жана кубаттуу · Сулайман-Тоо';
        case AvatarVisualState.normal:
          return 'Батыр тонуста · Ала-Тоо';
        case AvatarVisualState.tired:
          return 'Батыр чарчаган · Ала-Тоо';
        case AvatarVisualState.sleep:
          return 'Батыр эс алууда · Бурана мунарасы';
        case AvatarVisualState.postWorkout:
          return 'Батыр машыгуудан кийин · Бишкек Арена';
        case AvatarVisualState.meditation:
          return 'Батыр дзенде · Соң-Көл';
      }
    }
    return title;
  }
